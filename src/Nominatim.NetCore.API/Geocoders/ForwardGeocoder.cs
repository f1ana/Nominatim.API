...
namespace Nominatim.NetCore.API.Geocoders {
    ...
    public class ForwardGeocoder : GeocoderBase {
        ...
        public ForwardGeocoder(string URL = null, string ApplicationName = null) : base(URL ?? @"https://nominatim.openstreetmap.org/search", ApplicationName ?? @"f1ana.Nominatim.NetCore.API") {
        }
